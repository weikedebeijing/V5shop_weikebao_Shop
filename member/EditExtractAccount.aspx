<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditExtractAccount.aspx.cs" Inherits="V5APP.Store.UI.member.EditExtractAccount" %>
...
<body class="body-gray">
    ...
    <form class="mt-55 mlr-15">
        ...
        <input type="hidden" value="<%=cashAccount.ID %>" id="CashAccountID" />
        <!--logo end-->
        <div class="panel callout radius formstyle">
            <!--01 begin-->
            <div class="row collapse">
                <div class="small-12 large-12 columns">
                    <input type="text" placeholder="真实姓名" value="<%=cashAccount.CashRealName %>" id="CashRealName" name="CashRealName">
            ...
            <div class="row collapse">
                <div class="small-12 large-12 columns">
                    <input type="text" placeholder="账号" id="CashAccount" value="<%=cashAccount.CashAccount %>" name="CashAccount">
                      <span class="close-input" style="display: none;"></span>
                </div>
            </div>
            <!--02 end-->
            ...
            <div class="row collapse">
                <div class="small-12 large-12 columns">
                    <input type="text" placeholder="手机号码" id="CashPhone" value="<%=cashAccount.CashPhone %>" name="CashPhone">
                      <span class="close-input" style="display: none;"></span>
                </div>
            </div>
            <!--03 end-->
    ...
    $(function () {
        $("#btnSave").click(function () {
            ...
            $.ajax({
                ...
                data: { "action": "EditExtractAccount", "CashRealName": CashRealName, "CashAccount": CashAccount, "CashPhone": CashPhone, "Type": Type, "CashAccountID": CashAccountID },
                async: false,
                cache: false,
