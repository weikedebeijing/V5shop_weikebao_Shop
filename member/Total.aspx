<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Total.aspx.cs" Inherits="V5APP.Store.UI.member.Total" %>
...
<script src="../../member/js/chartline.js"></script>
 <script>
     function GetToDayPrice(){
         var strTimeslot = "<%=timeslot%>";
         var timeSlot = JSON.parse(strTimeslot);
         return timeSlot;
     }
     function GetYesterDayPrice()
     {
         var strTimeslot = "<%=yestertimeslot%>";
         var timeSlot = JSON.parse(strTimeslot);
         return timeSlot;
     }
     function GetThisWeekPrice() {
         var strTimeslot = "<%=thisWeekTimeSlot%>";
          var timeSlot = JSON.parse(strTimeslot);
          return timeSlot;
     }
     function GetThisMonthPrice() {
         var strTimeslot = "<%=thisMonthTimeSlot%>";
          var timeSlot = JSON.parse(strTimeslot);
          return timeSlot;
      }
...
<body>
  ...
  <div class="panel bro-yesterday">
    <p><i class="icon-monyg"></i>成交总额</p>
    <span>￥<%=priceAmount.ToString("0.00") %></span>
  </div>
  <!--yesterday end-->
  <!--table begin-->
  ...
  <div class="tabs-content tabcontent04">
    ...
    <div class="content active" id="panel2-1">
      <a href="DRPOrderList.aspx?DayOf=today" class="view-detail">查看详情</a>
      <div id="totaltoday" style="min-width:100%;height:400px;margin-top:10px;"></div> 
    </div>
    <!--totaltoday end-->
    <!--yestoday begin-->
    <div class="content" id="panel2-2">
      <a href="DRPOrderList.aspx?DayOf=yestoday" class="view-detail">查看详情</a>
      <div id="yestoday" style="min-width:100%;height:400px;margin-top:10px;"></div> 
    </div>    
    <!--yestoday end-->
    <!--weekday begin-->
    <div class="content" id="panel2-3">
      <a href="DRPOrderList.aspx?DayOf=weekday" class="view-detail">查看详情</a>
      <div id="weekday" style="min-width:100%;height:400px;margin-top:10px;"></div> 
    </div>    
    <!--weekday end-->
    <!--moonth begin-->
    <div class="content" id="panel2-4">
      <a href="DRPOrderList.aspx?DayOf=month" class="view-detail">查看详情</a>
