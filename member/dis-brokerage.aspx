<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dis-brokerage.aspx.cs" Inherits="V5APP.Store.UI.member.dis_brokerage" %>
...
<body>
  ...
  <div class="panel bro-yesterday">
    <p><i class="icon-monyg"></i>分销总提成</p>
    <span>￥<%=CommissionAmount.ToString("0.00") %></span>
  </div>
  <!--yesterday end-->
  <!--table begin-->
