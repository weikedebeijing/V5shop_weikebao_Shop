...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("                              <span class=\"name\">收货人:" + addressdefaultbyuid.Name.ToString() + "&nbsp;&nbsp;" + addressdefaultbyuid.Moblie.ToString() + "&nbsp;&nbsp;<br />" + addressdefaultbyuid.AddressInfo.ToString() + "\r\n");
	templateBuilder.Append("                              " + addressdefaultbyuid.PostCode.ToString() + "\r\n");
	...
	cart__loop__id=0;
	foreach(var cart in getTable("cart","["+username+"],["+guid+"]"))
	{
	...
	templateBuilder.Append("                                <img src=\"" + cart.Src.ToString() + "\" width=\"120\" height=\"120\" alt=\"产品\"></a>\r\n");
	templateBuilder.Append("                        </div>\r\n");
	templateBuilder.Append("                        <div class=\"info\">\r\n");
	templateBuilder.Append("                            <p class=\"info-name\">\r\n");
	templateBuilder.Append("                                " + cart.Name.ToString() + "<br/>" + cart.PropertysText.ToString() + "\r\n");
	templateBuilder.Append("                            </p>\r\n");
	templateBuilder.Append("                            <p class=\"info-price\">\r\n");
	templateBuilder.Append("                                <span class=\"count\">共 " + cart.count.ToString() + " 件</span><span class=\"price\"> ￥" + cart.OrderPrice.ToString() + "</span></p>\r\n");
	templateBuilder.Append("                        </div>\r\n");
	templateBuilder.Append("                    </li>\r\n");
