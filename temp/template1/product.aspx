...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by V5Shop Template Engine at 2014/9/26 17:04:48.
		本页面代码由V5Shop模板引擎生成于 2014/9/26 17:04:48. 
	*/
	...
	templateBuilder.Append("    <link rel=\"stylesheet\" type=\"text/css\" href=\"http://html.v5portal.com/mobile-template/yixun/css/common.css\">\r\n");
	templateBuilder.Append("    <link rel=\"stylesheet\" type=\"text/css\" href=\"http://html.v5portal.com/mobile-template/yixun/font/css/font-awesome.css\">\r\n");
	templateBuilder.Append("    <link rel=\"stylesheet\" type=\"text/css\" href=\"http://html.v5portal.com/mobile-template/yixun/css/pro-detail.css\">     \r\n");
	...
	templateBuilder.Append("        <span class=\"tit\" id=\"priceTitle\">惊爆价：</span>          <span class=\"price\" id=\"price\" price=\"¥311.00\">¥" + GetCustomerPrice( ProductDetailPrice.SalesPrice.ToString() ,productdetail.ID.ToString()).ToString() + "</span>        <del class=\"old_price\"><em id=\"priceMarket\" style=\"\">¥" + ProductDetailPrice.OldPrice.ToString() + "</em></del>\r\n");
